...
{
 if regex= (/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/;
...
let us - new User(firstName.volue, lastName.value, Fields gonder.value, address.value, country.value, email.value, newsletter.checked);

alert("${uslover irstName) thanks for registering.)
